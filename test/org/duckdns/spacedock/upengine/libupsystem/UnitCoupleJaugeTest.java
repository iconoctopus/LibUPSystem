...
public class UnitCoupleJaugeTest
{
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 20)).thenReturn(resultMock);
	jaugeFFA.recevoirDegats(20, persoMock);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 20);
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 50)).thenReturn(resultMock);
	jaugeSI.recevoirDegats(50, persoMock);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 50);
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 30)).thenReturn(resultMock);

	//d'abord la jauge de Fatigue/force d'âme : très grosse, elle encaissera bien
	jaugeFFA.recevoirDegats(30, persoMock);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 30);
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 23)).thenReturn(resultMock);
	jaugeFFA.recevoirDegats(23, persoMock);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 23);
	Assert.assertEquals(0, jaugeFFA.getBlessuresLegeres());
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 40)).thenReturn(resultMock);
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 10)).thenReturn(resultMockMort);//réussite du jet de mort, le perso reste en vie

	jaugeSI.recevoirDegats(40, persoMock);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 40);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 10);
	Assert.assertEquals(0, jaugeSI.getBlessuresLegeres());
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 55)).thenReturn(resultMock);
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.VOLONTE, 30)).thenReturn(resultMockInconscience);//échec du jet d'inconscience

	when(resultMockMort.isJetReussi()).thenReturn(true);
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 30)).thenReturn(resultMockMort);//réussite du jet de mort, le perso reste en vie

	jaugeFFA.recevoirDegats(55, persoMock);//on inflige un total de 6 blessures graves pour voir les effets sur la jauge externe
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 55);
	verify(persoMock).effectuerJetTrait(Perso.Trait.VOLONTE, 30);
	verify(persoMock).effectuerJetTrait(Perso.Trait.PHYSIQUE, 30);
	Assert.assertEquals(0, jaugeFFA.getBlessuresLegeres());
	...
	when(persoMock.effectuerJetTrait(Perso.Trait.PHYSIQUE, 30)).thenReturn(resultMockMort);//échec du jet de mort, le perso trépasse
