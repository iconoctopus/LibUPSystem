...
public class UnitCoupleJaugeTest
{
	...
	when(persoMock.effectuerJetTrait(0, 20)).thenReturn(resultMock);
	jaugeFFA.recevoirDegats(20, persoMock);
	verify(persoMock).effectuerJetTrait(0, 20);
	...
	when(persoMock.effectuerJetTrait(0, 50)).thenReturn(resultMock);
	jaugeSI.recevoirDegats(50, persoMock);
	verify(persoMock).effectuerJetTrait(0, 50);
	...
	when(persoMock.effectuerJetTrait(0, 30)).thenReturn(resultMock);
	...
	when(persoMock.effectuerJetTrait(0, 23)).thenReturn(resultMock);
	jaugeFFA.recevoirDegats(23, persoMock);
	verify(persoMock).effectuerJetTrait(0, 23);
	Assert.assertEquals(0, jaugeFFA.getBlessuresLegeres());
	...
	when(persoMock.effectuerJetTrait(0, 10)).thenReturn(resultMockMort);//réussite du jet de mort, le perso reste en vie

	jaugeSI.recevoirDegats(40, persoMock);
	verify(persoMock).effectuerJetTrait(0, 40);
	verify(persoMock).effectuerJetTrait(0, 10);
	Assert.assertEquals(0, jaugeSI.getBlessuresLegeres());
