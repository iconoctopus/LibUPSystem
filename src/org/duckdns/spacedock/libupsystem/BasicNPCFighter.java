...
public class BasicNPCFighter extends Perso
{
    ...
    public BasicNPCFighter(int p_RM) throws UPRollParameterFormatException
    {
    super();
    RM=p_RM;
	...
	public RollResult attaquer(int phaseActuelle, int ND) throws UPRollParameterFormatException
	{
